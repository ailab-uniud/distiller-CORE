...
public class TextAnnotation extends Annotation {
    ...
    public TextAnnotation(String annotator, String annotation) {
        this(annotator,null,annotation);
    }
    ...
    /**
     * Two text annotations are the same if the annotator, the annotated text
     * and the annotation are the same.
     *
     * For example, the words "Software" and "Engineering" may be annotated by
     * the same annotation from a "Wikipedia" annotator, the annotates the text
     * "Software Engineering" with the name of the "Software_Engineering" page.
     * Then, they may have two separated "Software" and "Engineering"
